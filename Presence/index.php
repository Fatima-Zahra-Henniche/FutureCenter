...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Simulate student data loading (replace with actual implementation)
                ...
                sampleStudents.forEach(student => {
                    ...
                    studentItem.innerHTML = `
                        ...
                        <div class="attendance-controls">
                            <button class="attendance-btn btn-present" data-student-id="${student.id}">
                                <i class="fas fa-check"></i> حاضر
                            </button>
                            <button class="attendance-btn btn-absent" data-student-id="${student.id}">
